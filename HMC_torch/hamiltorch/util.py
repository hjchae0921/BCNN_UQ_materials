...
_new_methods = {'conv2d_forward','_forward_impl', '_check_input_dim', '_conv_forward',
                ...
                "get_expected_cell_size", "permute_hidden", "optional_step_en", "optional_step_dec"}
...
def _make_functional(module, params_box, params_offset):
    ...
    for name, attr in module.__dict__.items():
        ...
        # print('non-internal attribute:'+name)
    ...
    for name in dir(module):
        if name in _new_methods:
            ...
            if name == 'optional_step_en':
                setattr(self, name, types.MethodType(type(module).optional_step_en,self))
            if name == 'optional_step_dec':
                setattr(self, name, types.MethodType(type(module).optional_step_dec,self)) 
